...
export default {
    ...
    LOAD_APPLICATION_FORM_REQUEST: 'LOAD_APPLICATION_FORM_REQUEST',
    LOAD_APPLICATION_FORM_SUCCESS: 'LOAD_APPLICATION_FORM_SUCCESS',
    LOAD_APPLICATION_FORM_ERROR: 'LOAD_APPLICATION_FORM_ERROR',
    ...
    ADMIN_LOAD_DOCUMENT_REQUEST: 'ADMIN_LOAD_DOCUMENT_REQUEST',
    ADMIN_LOAD_DOCUMENT_SUCCESS: 'ADMIN_LOAD_DOCUMENT_SUCCESS',
    ADMIN_LOAD_DOCUMENT_FAILURE: 'ADMIN_LOAD_DOCUMENT_FAILURE',
    ADMIN_LOAD_FORM_REQUEST: 'ADMIN_LOAD_FORM_REQUEST',
    ADMIN_LOAD_FORM_SUCCESS: 'ADMIN_LOAD_FORM_SUCCESS',
    ADMIN_LOAD_FORM_FAILURE: 'ADMIN_LOAD_FORM_FAILURE',
    ADMIN_UPDATE_DOCUMENT_REQUEST: 'ADMIN_UPDATE_DOCUMENT_REQUEST',
    ADMIN_UPDATE_DOCUMENT_SUCCESS: 'ADMIN_UPDATE_DOCUMENT_SUCCESS',
    ADMIN_UPDATE_DOCUMENT_FAILURE: 'ADMIN_UPDATE_DOCUMENT_FAILURE',
    ADMIN_DELETE_DOCUMENT_REQUEST: 'ADMIN_DELETE_DOCUMENT_REQUEST',
    ADMIN_DELETE_DOCUMENT_SUCCESS: 'ADMIN_DELETE_DOCUMENT_SUCCESS',
    ADMIN_DELETE_DOCUMENT_FAILURE: 'ADMIN_DELETE_DOCUMENT_FAILURE',

    LOAD_GAME_QUESTIONS_REQUEST: 'LOAD_GAME_QUESTIONS_REQUEST',
    LOAD_GAME_QUESTIONS_SUCCESS: 'LOAD_GAME_QUESTIONS_SUCCESS',
    LOAD_GAME_QUESTIONS_FAILURE: 'LOAD_GAME_QUESTIONS_FAILURE',
    LOAD_GAMESTATE_REQUEST: 'LOAD_GAMESTATE_REQUEST',
    LOAD_GAMESTATE_SUCCESS: 'LOAD_GAMESTATE_SUCCESS',
    LOAD_GAMESTATE_FAILURE: 'LOAD_GAMESTATE_FAILURE',
    UPLOAD_GAME_QUESTIONS_REQUEST: 'UPLOAD_GAME_QUESTIONS_REQUEST',
    UPLOAD_GAME_QUESTIONS_SUCCESS: 'UPLOAD_GAME_QUESTIONS_SUCCESS',
    UPLOAD_GAME_QUESTIONS_FAILURE: 'UPLOAD_GAME_QUESTIONS_FAILURE'
};
