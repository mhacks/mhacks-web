...
/* Page Component */
class SpeakerReader extends React.Component {
    constructor() {
        super();
    ...
    componentDidMount() {
        this.props.dispatch(ReaderThunks.loadSpeakerApplications());
    }
    ...
    render() {
        return (
            <PageContainer ref="pagecontainer">
                ...
                />
                <ReactTable
                    data={this.props.readerState.data.speakerApplications}
...
export default connect(mapStateToProps)(SpeakerReader);
